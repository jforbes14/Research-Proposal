...
Violin plots of the complete set of variables in the electorate profiles can be found in the appendix (see \@ref(fig:vis-census1),\@ref(fig:vis-census2),\@ref(fig:vis-census3),\@ref(fig:vis-census4)).
